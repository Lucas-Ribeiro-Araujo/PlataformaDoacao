...
public class GerenciaDoador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTableAlunos.getColumnModel().getColumnCount() > 0) {
            ...
            jTableAlunos.getColumnModel().getColumn(2).setHeaderValue("Endereço");
            jTableAlunos.getColumnModel().getColumn(3).setMinWidth(100);
            jTableAlunos.getColumnModel().getColumn(3).setHeaderValue("Telefone");
            jTableAlunos.getColumnModel().getColumn(4).setHeaderValue("Cpf");
        }
...
//            }
    ...
    private void jTableAlunosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAlunosMouseClicked
        ...
        if (this.jTableAlunos.getSelectedRow() != -1) {
            ...
            this.c_endereco.setText(idade);
            this.c_telefone.setText(curso);
            this.c_cpf.setText(fase);
